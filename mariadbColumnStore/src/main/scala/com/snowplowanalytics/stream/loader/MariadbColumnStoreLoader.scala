...
import com.snowplowanalytics.stream.loader.clients.{BulkSender, MariadbColumnStoreBulkSender}
...
/** Main entry point for the MariaDB ColumnStore sink */
object MariadbColumnStoreLoader {
